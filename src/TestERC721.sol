...
contract TestERC721 is ERC721URIStorage, ERC721Enumerable, ERC721Burnable {
    /* ========== STATE VARIABLES ========== */
     ...
     */
    function issueToken(address recipient, string memory hash) public returns (uint256) {
        tokenId.increment();
     ...
     */
    function issueBatch(address recipient, string[] memory _hashes) public returns (uint256[] memory) {
